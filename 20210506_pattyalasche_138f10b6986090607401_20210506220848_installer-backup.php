...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210506_pattyalasche_138f10b6986090607401_20210506220848_archive.zip';
	const ARCHIVE_SIZE		 = '194418086';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '138f10b-06220848';
    const SECONDARY_PACKAGE_HASH = '1d4f82d-06220848';
	const VERSION			 = '1.4.0';
